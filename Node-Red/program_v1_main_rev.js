[
    ...
    },
    {
        ...
        "z": "7b2681a7fde4633e",
        "name": "parsing id 2",
        "func": "// =====================================================\n// PARSER ID 2 ANALOG 0-5000\n// Input contoh:\n// 4998,0,0,0,0,0,0,4855\n// =====================================================\n\nlet raw = msg.payload.raw_data || [];\n\nlet tags = [\n    \"CH1_value\",\n    \"CH2_value\",\n    \"CH3_value\",\n    \"CH4_value\",\n    \"CH5_value\",\n    \"CH6_value\",\n    \"CH7_value\",\n    \"CH8_value\"\n];\n\nlet result = {};\n\ntags.forEach(function(tag,index){\n    let value = Number(raw[index] || 0);\n    result[tag] = {\n        raw:value,\n        percent:Number(((value / 5000) * 100).toFixed(2))\n    };\n});\n\nmsg.payload = {\n    slave:\"R9C\",\n    range:\"0-5000\",\n    raw_data:raw,\n    device:result\n};\n\nreturn msg;",
        "outputs": 1,
        "timeout": 0,
        "noerr": 0,
        "initialize": "",
